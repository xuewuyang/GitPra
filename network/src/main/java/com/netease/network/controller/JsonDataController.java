...
import com.netease.network.vo.Result;
...
public class JsonDataController {
	...
	public Boolean buy(@RequestBody List<SoldItemDo> list) {
    ...
    public Boolean publicProduct(ModelMap modelMap,@RequestBody PublicProductDo productVo) {
